  ...
  return (
    <footer aria-label="Site Footer">
      <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className=" text-gray-500 items-center text-center flex flex-col justify-center">
          <p className="flex">
            Made with
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              className="w-5 h-5 text-red-700 mx-1"
            >
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-cup-hot-fill text-gray-500 mx-1"
              viewBox="0 0 16 16"
            >
              <path
                fillRule="evenodd"

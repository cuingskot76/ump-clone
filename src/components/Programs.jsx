      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            ...
            doloribus! Facilis fuga molestiae sint voluptates neque qui minima
            est autem voluptate, at, commodi eos rem!
          </p>
        </div>
        {/* program */}
          ...
          <div className="grid gap-8 row-gap-5 lg:grid-cols-3">
            ...
            <div className="relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
              ...
              <div className="relative p-5 bg-gray-100 rounded-sm">
                ...
                <p className="mb-2 text-sm text-gray-900">
                  ...
                  Possimus facilis est itaque? Enim explicabo cupiditate magnam
                  consequatur aperiam voluptatum ut!
                </p>
                <a
                  href="/"
                  aria-label=""
            ...
            <div className="relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
              ...
              <div className="relative p-5 bg-gray-100 rounded-sm">
                ...
                <p className="mb-2 text-sm text-gray-900">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Dolores iure, odit labore soluta corporis omnis amet,
                  repudiandae quibusdam tempore doloremque eos quae, sunt
                  mollitia aliquam.
                </p>
                <a
                  href="/"

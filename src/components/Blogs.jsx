    ...
    <div className="py-16">
      <div className="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        ...
        <div className="grid gap-12 md:gap-6 md:grid-cols-2 lg:gap-12">
          <div className="group space-y-6 shadow-2xl shadow-gray-900/10 p-4 sm:p-6  rounded-xl ">
            <img
                ...
                >
                  ...
                  <g mask="url(#mask__beam)">
                    ...
                    <rect
                      ...
                      width="36"
                      height="36"
                      transform="translate(-1 5) rotate(145 18 18) scale(1.1)"
                      fill="#ffad08"
                      rx="36"
                    ></rect>
          ...
          <div className="group space-y-6 shadow-2xl shadow-gray-900/10 p-4 sm:p-6  rounded-xl ">
            ...
            />
            <h3 className="text-3xl font-semibold text-gray-800 dark:text-white">
              Volutpat vestibulum risus fusce convallis ultricies nascetur dui
              netus sociosqu facilisi
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tenetur
              rerum facilis labore consectetur et! Nulla, necessitatibus saepe.
              Quos reprehenderit, laborum libero earum reiciendis magni
              cupiditate consequatur fugit! Saepe, in quisquam.
            </p>
